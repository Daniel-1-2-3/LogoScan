...
export function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-900 to-green-600 text-white">
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 pt-36">
          <div className="text-center">
            <h1 className="text-7xl font-bold text-white mt-25 mb-6">
            Scan. Score. Sustain
            </h1>
            <p className="text-xl text-gray-275 mb-10 max-w-4xl mx-auto">
            Analyze the sustainability practices of your favourite companies, and find the next best step today
            </p>
            <Link
              to="/login"
      ...
      {/* Features Section */}
      <section id="features" className="w-full py-12 justify-items-center mt-5">
        <div className="container px-4 md:px-6 pb-16">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="inline-flex items-center rounded-full border border-white px-2.5 py-2 text-sm font-semibold text-white">
              ...
              <h2 className="text-4xl font-bold tracking-tighter sm:text-5xl mt-5 ">Sustainability at Your Fingertips</h2>
            </div>
          </div>
          <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
            <div className="flex flex-col items-center rounded-lg bg-green-100 text-green-800 p-6 shadow-sm">
              <div className="rounded-full bg-green-100 p-3 mt-1">
                <Scan className="h-8 w-8 text-green-600" />
              </div>
              <h3 className="text-xl font-bold m-3">Instant Scanning</h3>
            ...
            <div className="flex flex-col items-center rounded-lg bg-green-100 text-green-800 p-6 shadow-sm">
              ...
              <h3 className="text-xl font-bold m-3">Detailed Reports</h3>
              <p className="text-center text-gray-600 mt-2 mb-4">
            ...
            <div className="flex flex-col items-center rounded-lg bg-green-100 text-green-800 p-6 shadow-sm">
              ...
              <h3 className="text-xl font-bold m-3">Verified Data</h3>
              <p className="text-center text-gray-600 mt-2 mb-4">
